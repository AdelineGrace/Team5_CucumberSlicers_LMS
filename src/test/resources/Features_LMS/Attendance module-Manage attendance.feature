...
@tag
Feature: Manage Attendance Page verification, Attendance details popup window  verification, Add new Attendance 
Edit Attendance, Delete attendance validation, Delete multiple attendance validation, Pagination in manage attendance
Navigation function validation from manage attendance page to other pages  
 ...
 @Attendance1
    ...
    Given Admin is on dashboard page after Login
    When Admin clicks "Attendance" on the navigation bar
    Then HTTP response >= "400" after the link is broken
