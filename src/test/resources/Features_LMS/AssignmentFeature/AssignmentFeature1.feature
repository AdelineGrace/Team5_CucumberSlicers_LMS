...
Then Admin should see URL with Manage Assignment from "<SheetName>" and <RowNumber>
Examples:
| SheetName | RowNumber |
| Assignment    |   1       |
...
#3
Scenario Outline: Validate the header
Given Admin is on dashboard page after Login
When Admin clicks Assignment on the navigation bar
Then Admin should see a heading with text Manage Assignment from "<SheetName>" and <RowNumber>
Examples:
| SheetName | RowNumber |
| Assignment    |   1       |

#4
Scenario Outline: Validate the text in header
Given Admin is on dashboard page after Login
When Admin clicks Assignment button on the navigation bar and get all text from the portal page "<SheetName>" and <RowNumber>
