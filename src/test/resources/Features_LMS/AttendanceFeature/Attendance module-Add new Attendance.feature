Feature: Add new Attendance
  ...
  Scenario Outline: Validate admin able to create new attendance
    ...
    When Admin fills values Programname ,classname,studentname,Attendance,attendancedate and click save from "<Sheetname>" and <Rownumber>
...
Examples: 
  ...
  Scenario Outline: Validate admin able to create new attendance data without program name
    Given Admin is in  attendance details popup window
    When Admin fills values and click save without program name from "<Sheetname>" and <Rownumber> 
    Then Status is status Program name is missing from "<Sheetname>" and <Rownumber> 
Examples: 
      | Sheetname         | Rownumber |
      | Attendance Detais |         2 |
  Scenario Outline: Validate admin able to create new attendance data without class name
    Given Admin is in  attendance details popup window
    When Admin fills values  and click save  without class name from "<Sheetname>" and <Rownumber> 
...
Examples: 
  ...
  Scenario Outline: Validate admin able to create new attendance data without student name
    Given Admin is in  attendance details popup window
    When Admin fills values and click save without student name from "<Sheetname>" and <Rownumber> 
...
Examples: 
  ...
  Scenario Outline: Validate admin able to create new attendance data without attendances
    Given Admin is in  attendance details popup window
    When Admin fills values and click save without attendances from "<Sheetname>" and <Rownumber>2
