...
public class Assignment_PageObject {
    ...
    By LeftArrowPagination = By.xpath("//div[@class='pagination']//a[@class='left']");
	 ...
	 WebDriver driver;
		...
		public  Assignment_PageObject(WebDriver driver)
		{
			this.driver = driver;
		...
		public void GradeByTextBox(List<String> GradeBy) throws InterruptedException
		{
		 for(String contents : GradeBy) { 
			((org.openqa.selenium.Alert) driver.findElements((By) GradeBy)).sendKeys(contents);
			Thread.sleep(1000);
		}
		}
...
//			}
		 ...
		 public void BatchNumberDropDownText(List<String> batchnumberdropdown) throws InterruptedException
			{
			 Select dropdown = new Select(driver.findElement(BatchNumberDropdown));
			 for (String id : batchnumberdropdown )
			 {

                dropdown.selectByValue(id);
			}
			}
		 public void StaffIdDropDownText(List<String> staffid) throws InterruptedException
			{
			 Select dropdown = new Select(driver.findElement(BatchNumberDropdown));
		 ...
		 public void ClassDateCalender(List<String> classdate) throws InterruptedException
			{
			 ...
			 public void Assignment2(List<String> assignment2) throws InterruptedException
				{
				 for(String contents : assignment2) { 
					driver.findElement(Assignment2).sendKeys(contents);
					Thread.sleep(1000);
				}
				}
			 public void AssignmentName(List<String> assignmentname) throws InterruptedException
				{
				 for(String contents : assignmentname) { 
					driver.findElement(AssignmentName).sendKeys(contents);
					Thread.sleep(1000);
				}
				}
			 public void AssignmentDueDate(List<String> assignmentduedate) throws InterruptedException
				{
				 for(String contents : assignmentduedate) { 
					driver.findElement(AssignmentDueDate).sendKeys(contents);
					Thread.sleep(1000);
				}
				}
			 
			 public void Assignment3(List<String> assignment3) throws InterruptedException
				{
				 for(String contents : assignment3) { 
					driver.findElement(Assignment3).sendKeys(contents);
					Thread.sleep(1000);
				}
				}
			 public void Assignment4(List<String> assignment4) throws InterruptedException
				{
				 for(String contents : assignment4) { 
					driver.findElement(Assignment4).sendKeys(contents);
					Thread.sleep(1000);
				}
				}
			 public void Assignment5(List<String> assignment5) throws InterruptedException
				{
				 for(String contents : assignment5) { 
