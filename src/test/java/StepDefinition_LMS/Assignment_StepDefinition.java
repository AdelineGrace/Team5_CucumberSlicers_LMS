...
import POM_LMS.AssignmentPOM_LMS;
...
{
	WebDriver driver;
	AssignmentPOM_LMS assignmentpage = new AssignmentPOM_LMS(DriverFactory.getDriver()); 
//#1	
...
//#36---Add new Assignment
	...
	public void admin_enters_all_mandatory_field_values_with_valid_data_and_clicks_save_button_program_name_batch_number_assignment_name_grade_by_assignment_due_date_from_and(String SheetName, Integer RowNumber) 
	{
...
//#37
	...
	public void admin_enters_all_mandatory_field_values_with_invalid_data_and_clicks_save_button_program_name_batch_number_assignment_name_grade_by_assignment_due_date_from_and(String SheetName, Integer RowNumber) 
	{
		...
		List<String> staffid = excel.getCellData(SheetName, 22, RowNumber);
		 ...
		 assignmentpage.BatchIdDropDown(batchid);
		 assignmentpage.ClassNoTextBox(classno);
		 assignmentpage.ClassDateCalender(classdate);
		 assignmentpage.StaffIdDropDown(staffid);
		 assignmentpage.Click_Save();
	}
...
//38
	...
	public void admin_enters_values_in_all_fields_with_valid_data_and_clicks_save_button_program_name_batch_number_assignment_name_assignment_description_grade_by_assignment_due_date_assignment_file1_assignment_file2_assignment_file3_assignment_file4_assignment_file5_from_and(String SheetName, Integer RowNumber) {
	...
	@When("Admin enters with invalid data in optional fields and clicks save button \\(Assignment File1, Assignment file2, Assignment file3, Assignment file4, Assignmentfile5)from {string} and {int}")
	public void admin_enters_with_invalid_data_in_optional_fields_and_clicks_save_button_assignment_file1_assignment_file2_assignment_file3_assignment_file4_assignmentfile5_from_and(String SheetName, Integer RowNumber) {
	...
	@When("Admin enters data missing value in program name and clicks save button \\(batch number,Assignment Name, Assignment Description, grade by, Assignment due date, Assignment File1, Assignment file2, Assignment file3, Assignment file4, Assignment file5)	from {string} and {int}")
	public void admin_enters_data_missing_value_in_program_name_and_clicks_save_button_batch_number_assignment_name_assignment_description_grade_by_assignment_due_date_assignment_file1_assignment_file2_assignment_file3_assignment_file4_assignment_file5_from_and(String SheetName, Integer RowNumber) {
	...
	@When("Admin enters data missing value in Batch number and clicks save button \\(Program name,Assignment Name, Assignment Description, grade by, Assignment due date, Assignment File1, Assignment file2, Assignment file3, Assignment file4, Assignment file5)from {string} and {int}")
	public void admin_enters_data_missing_value_in_batch_number_and_clicks_save_button_program_name_assignment_name_assignment_description_grade_by_assignment_due_date_assignment_file1_assignment_file2_assignment_file3_assignment_file4_assignment_file5_from_and(String SheetName, Integer RowNumber) {
	...
	public void admin_enters_data_missing_value_in_assignment_name_and_clicks_save_button_program_name_batch_number_assignment_name_grade_by_assignment_due_date_from_and(String SheetName, Integer RowNumber) {
	...
	public void admin_enters_data_missing_value_in_assignment_due_date_and_clicks_save_button_program_name_batch_number_assignment_name_grade_by_from_and(String SheetName, Integer RowNumber) {
		Loggerload.info(" Missing Class Date in Add Class Page");
		ExcelReader excel = new ExcelReader("C:\\Users\\praka\\git\\Team5_CucumberSlicers_LMS\\src\\test\\resources\\ExcelData");
	...
	public void admin_enters_data_missing_value_in_grade_by_and_clicks_save_button_program_name_batch_number_assignment_name_assignment_due_date_from_and(String SheetName, Integer RowNumber) {
		Loggerload.info(" Missing Class Date in Add Class Page");
		ExcelReader excel = new ExcelReader("C:\\Users\\praka\\git\\Team5_CucumberSlicers_LMS\\src\\test\\resources\\ExcelData");
	...
	public void grade_byis_missing() {
		String expectedClassDateErrormessage = ClassDateError();
	    String actualClassDateErrorMessage = classpage.Alert();
	    assertTrue(actualClassDateErrorMessage.contains(expectedClassDateErrormessage));
	}
	...
	public void admin_enters_passed_date_in_the_due_date_field_and_clicks_save_button_program_name_batch_number_assignment_name_grade_by_assignment_due_date_from_and(String SheetName, Integer RowNumber) {
	...
	public void admin_clicks_date_from_date_picker_from_and(String SheetName, Integer RowNumber)
	{
	...
	@When("Admin clicks Cancel button without entering values in the fields	from {string} and {int}")
	public void admin_clicks_cancel_button_without_entering_values_in_the_fields_from_and(String string, Integer int1) throws InterruptedException {
		Loggerload.info(" Admin clicks Cancel button without entering values in the fields ");

		assignmentpage.Click_Cancel();
	}

	@Then("Admin should land on manage assignment page from {string} and {int}")
	public void admin_should_land_on_manage_assignment_page_from_and(String SheetName, Integer RowNumber) throws IOException
	{
	...
	@Then("Admin should land on manage assignment Page and validate new assignment is not created in the data tablefrom {string} and {int}")
	public void admin_should_land_on_manage_assignment_page_and_validate_new_assignment_is_not_created_in_the_data_tablefrom_and(String SheetName, Integer RowNumber) {
		ExcelReader excel = new ExcelReader("C:\\Users\\praka\\git\\Team5_CucumberSlicers_LMS\\src\\test\\resources\\ExcelData");
		List<String> expectedClassUrl = excel.getCellData(SheetName, 0, RowNumber);
		String actualClassUrl = getClassURL();
		 Assert.assertEquals(expectedClassUrl, actualClassUrl);
...
//#54---	Edit assignment Validation Part1
	...
	{
		WebElement classdetails = assignmentpage.AssignmentDetails();
		Assert.assertTrue(AssignmentDetails.isDisplayed(), "Assignment Details pop up not appeared");
	}
//#55
...
//#55---Edit assignment Validation Part2
	...
	public void admin_should_see_updated_assignment_details_is_added_in_the_data_table_and(String SheetName, Integer RowNumber) throws InterruptedException 
	{
		ExcelReader excel = new ExcelReader("C:\\Users\\praka\\git\\Team5_CucumberSlicers_LMS\\src\\test\\resources\\ExcelData");
		 Thread.sleep(1000);
	List<String> batchid = excel.getCellData(SheetName, 13, RowNumber);
	...
	String expectedfields = "Batch ID: " + batchid + ", Class Date: " + classdate +
          ", Class No: " + classno + ", Staff ID: " + staffid;
    List<String> editedFields = assignmentpage.DataTable();
...
//	@When("Admin clicks Cancel button without entering values in the fields	from {string} and {int}")
//	public void admin_clicks_cancel_button_without_entering_values_in_the_fields_from_and(String string, Integer int1) {
//	    // Write code here that turns the phrase above into concrete actions
//	    throw new io.cucumber.java.PendingException();
//	}
//
//	@Then("Admin should land on manage assignment page from {string} and {int}")
//	public void admin_should_land_on_manage_assignment_page_from_and(String string, Integer int1) {
//	    // Write code here that turns the phrase above into concrete actions
//	    throw new io.cucumber.java.PendingException();
//	}
//
...
//
//	@Then("Admin should land on manage assignment Page and validate new assignment is not created in the data tablefrom {string} and {int}")
//	public void admin_should_land_on_manage_assignment_page_and_validate_new_assignment_is_not_created_in_the_data_tablefrom_and(String string, Integer int1) {
//	    // Write code here that turns the phrase above into concrete actions
//	    throw new io.cucumber.java.PendingException();
//	}
	
//Delete Assignment Validation Part1
	...
	{
		 Alert alert = assignmentpage.DeleteAlert();
...
//Delete Multiple Class Validation Part1
	...
	public void admin_clicks_single_row_level_check_box_in_the_data_table()
	{
		...
		assignmentpage.Click_CheckBoxA();
	}
...
{
	assignmentpage.Click_BatchIdSort();
	assignmentpage.Click_BatchIdSort(); 
}
...
public void admin_should_see_data_table_sorted_in_ascending_order()
{
    ...
    Assert.assertTrue(tablesortedlist.equals(assignmentpage.BatchIdSortedList()), "Data table is not sorted in ascending order");
}
...
@When("Admin clicks {string} button on the navigation barfrom {string} and {int}")
public void admin_clicks_button_on_the_navigation_barfrom_and(String string, String string2, Integer int1)
{
...
@When("Admin clicks {string} button on the navigation bar	from {string} and {int}")
public void admin_clicks_button_on_the_navigation_bar_from_and(String string, String string2, Integer int1)
{
...
public void admin_creates_six_new_assignment_from_and(String SheetName, Integer RowNumber)
 {
...
public void admin_creates_less_than_or_equal_to_five_new_assignment_from_and(String SheetName, Integer RowNumber)
 {
  int startrow = 2;
	for (int i = 0; i <= 5; i++) {
        	ExcelReader excel = new ExcelReader("C:\\Users\\shaun\\eclipse-workspace\\Team5_CucumberSlicers_LMS\\src\\test\\resources\\ExcelData\\LMS_excel.xlsx");
...
List<String> assignment5 = excel.getCellData(SheetName, 28, startrow);
 ...
 assignmentpage.BatchNumberDropDownText(batchnumber);
 assignmentpage.AssignmentNumber(assignmentnumber);
 assignmentpage.AssignmentDescriptionTextBox(assignmentdescription);
 assignmentpage.AssignmentGradeTxt(assignmentgradetxt);
 assignmentpage.AssignmentDueDate(assignmentduedate);
